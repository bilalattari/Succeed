...
const styles = StyleSheet.create({
    ...
    name: { fontSize: 16, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    sportname: { fontSize: 18, marginLeft: 10, marginTop: 5, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    location: { fontSize: 13, marginLeft: 10, marginTop: 5, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    subtxt: { fontSize: 13, color: '#A1A3B2', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    btntxt: { fontSize: 18, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    priceview: { flexDirection: 'row', alignSelf: 'flex-end', marginRight: 10, marginTop:30, },
    price: { fontSize: 15, marginLeft: 5, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    typeview: { position: 'absolute', top: 10, left: 10, flexDirection: 'row', alignItems: 'center', },
    typetxt: { marginLeft: 5, backgroundColor: '#FFFFFF35', paddingHorizontal: 15, paddingVertical: 5, borderRadius: 30, fontSize: 15, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    bottomview: { alignItems: 'center', padding: 10, marginTop: 10, width: '100%', backgroundColor: '#E4E6ED', flexDirection: 'row', },
    date: { flex: 2, fontSize: 12, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    timeview: { flex: 1.5 },
    timetxt: {marginTop:5, fontSize: 12, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
