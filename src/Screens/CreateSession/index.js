...
const styles = StyleSheet.create({
    ...
    subheading: { paddingLeft: 20, fontSize: 16, color: '#727484', fontFamily: 'AvenirNextLTPro-Regular' },
    subheadinggreen: { paddingLeft: 5, fontSize: 12, color: '#2FB553', fontFamily: 'AvenirNextLTPro-Regular' },
    subheadingblue: { paddingLeft: 5, fontSize: 12, color: '#0078FF', fontFamily: 'AvenirNextLTPro-Regular' },
