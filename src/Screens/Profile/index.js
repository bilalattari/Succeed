...
const styles = StyleSheet.create({
    ...
    headertxt: { fontSize: 18, color: '#000', fontFamily: 'AvenirNextLTPro-Regular' },
    detailview: { marginTop: 60, backgroundColor: '#FFF' },
    avatar: { resizeMode: 'contain', marginTop: -60, width: 120, height: 120, alignSelf: 'center' },
    heading: { textAlign: 'center', marginVertical: 5, fontSize: 25, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    subheading: { textAlign: 'center', marginVertical: 5, fontSize: 13, color: '#7D7F8D', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    profiletxt: { fontSize: 16, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    subtxt: { fontSize: 12, color: '#0078FF', fontFamily: 'AvenirNextLTPro-Regular' },
    priceview: { alignItems: 'center', flexDirection: 'row', alignSelf: 'flex-end', marginRight: 10, marginTop: 5 },
    price: { fontSize: 12, marginLeft: 5, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    sportnametxt: { marginLeft: 5, fontSize: 16, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
})
