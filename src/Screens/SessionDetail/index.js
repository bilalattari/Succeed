...
const styles = StyleSheet.create({
    ...
    headertxt: { fontSize: 18, color: '#FFF', fontFamily: 'AvenirNextLTPro-Bold' },
    ...
    dateview: { padding: 10, flex: 1.7, fontSize: 12, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    datetxt: { fontSize: 12, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    timeview: { padding: 10, flex: 1.5 },
    timetxt: { marginTop: 5, fontSize: 12, color: '#363232', fontFamily: 'AvenirNextLTPro-Bold' },
    timeheadtxt: { marginLeft: 5, fontSize: 10, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    detailcontainer: { padding: 10, justifyContent: 'center', alignItems: 'center', },
    heading: { marginVertical: 5, fontSize: 20, color: '#363232', fontFamily: 'AvenirNextLTPro-Bold' },
    subheading: { marginVertical: 5, fontSize: 13, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    locationtxt: { fontSize: 13, marginLeft: 3, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    title: { fontSize: 12, marginBottom: 5, color: '#7D7F8D', fontFamily: 'AvenirNextLTPro-Regular' },
    value: { fontSize: 14, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    decsview: { paddingVertical: 10, },
    deschead: { fontSize: 14, color: '#7D7F8D', marginBottom: 10, fontFamily: 'AvenirNextLTPro-Regular' },
    desctxt: { fontSize: 14, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    jointxt: { fontSize: 18, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    profileview: { paddingHorizontal: 15, paddingVertical: 10, },
    sessiontxt: { fontSize: 15, color: '#7D7F8D', fontFamily: 'AvenirNextLTPro-Regular' },
    ...
    profiletxt: { fontSize: 15, color: '#FFF', fontFamily: 'AvenirNextLTPro-Regular' },
    avatar: { resizeMode: 'contain', width: 50, height: 50 },
    name: { fontSize: 18, color: '#363232', fontFamily: 'AvenirNextLTPro-Regular' },
    prodesc: { fontSize: 14, marginTop:10, color: '#5A6088', fontFamily: 'AvenirNextLTPro-Regular' },
})
